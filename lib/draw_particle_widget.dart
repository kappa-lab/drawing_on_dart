...
class _HomeState extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _HomeStateState();
}

class _HomeStateState extends State<_HomeState> with TickerProviderStateMixin {
...
class _MyPainter extends CustomPainter {
  ...
  void _draw(Canvas canv, Particle pt, [Color color = Colors.red]) {
    canv.drawCircle(
